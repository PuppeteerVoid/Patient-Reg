...
class HomePageNormalPHCKafAKafanchan extends StatefulWidget {
  HomePageNormalPHCKafAKafanchan({super.key});

  @override
  State<HomePageNormalPHCKafAKafanchan> createState() => _HomePageNormalPHCKafAKafanchanState();
}

class _HomePageNormalPHCKafAKafanchanState extends State<HomePageNormalPHCKafAKafanchan> {
  ...
  String id ='';
  String region = 'PHC Kaf A Kafanchan';
