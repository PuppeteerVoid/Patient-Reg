...
class HomePageNormalPHCTudenWadaZaria extends StatefulWidget {
  HomePageNormalPHCTudenWadaZaria({super.key});

  @override
  State<HomePageNormalPHCTudenWadaZaria> createState() => _HomePageNormalPHCTudenWadaZariaState();
}

class _HomePageNormalPHCTudenWadaZariaState extends State<HomePageNormalPHCTudenWadaZaria> {
  ...
  String id ='';
  String region = 'PHC Tudun Wada Zaria';
