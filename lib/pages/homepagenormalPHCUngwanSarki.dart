...
class HomePageNormalPHCUngwanSarki extends StatefulWidget {
  HomePageNormalPHCUngwanSarki({super.key});

  @override
  State<HomePageNormalPHCUngwanSarki> createState() => _HomePageNormalPHCUngwanSarkiState();
}

class _HomePageNormalPHCUngwanSarkiState extends State<HomePageNormalPHCUngwanSarki> {
  ...
  String id ='';
  String region = 'PHC Ungwan Sarki';
