...
class HomePageNormalPHCTelevision extends StatefulWidget {
  HomePageNormalPHCTelevision({super.key});

  @override
  State<HomePageNormalPHCTelevision> createState() => _HomePageNormalPHCTelevisionState();
}

class _HomePageNormalPHCTelevisionState extends State<HomePageNormalPHCTelevision> {
