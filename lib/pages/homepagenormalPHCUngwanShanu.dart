...
class HomePageNormalPHCUngwanShanu extends StatefulWidget {
  HomePageNormalPHCUngwanShanu({super.key});

  @override
  State<HomePageNormalPHCUngwanShanu> createState() => _HomePageNormalPHCUngwanShanuState();
}

class _HomePageNormalPHCUngwanShanuState extends State<HomePageNormalPHCUngwanShanu> {
  ...
  String id ='';
  String region = 'PHC Ungwan Shanu';
