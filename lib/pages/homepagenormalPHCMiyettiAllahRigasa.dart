...
class HomePageNormalPHCMiyettiAllahRigasa extends StatefulWidget {
  HomePageNormalPHCMiyettiAllahRigasa({super.key});

  @override
  State<HomePageNormalPHCMiyettiAllahRigasa> createState() => _HomePageNormalPHCMiyettiAllahRigasaState();
}

class _HomePageNormalPHCMiyettiAllahRigasaState extends State<HomePageNormalPHCMiyettiAllahRigasa> {
  ...
  String id ='';
  String region = 'PHC Miyetti Allah Rigasa';
